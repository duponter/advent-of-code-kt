    ...
    given("day 06") {
        ...
        on("part 1") {
            it("turn on 0,0 through 999,999 would turn on (or leave on) every light") {
                assertEquals(1, day06.part1(LinesFromArray("turn on 0,0 through 999,999")))
            }
            it("toggle 0,0 through 999,0 would toggle the first line of 1000 lights") {
                assertEquals(1, day06.part1(LinesFromArray("toggle 0,0 through 999,0")))
            }
            it("turn off 499,499 through 500,500 would turn off (or leave off) the middle four lights") {
                assertEquals(1, day06.part1(LinesFromArray("turn off 499,499 through 500,500")))
            }
